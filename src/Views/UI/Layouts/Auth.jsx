...
const Auth = ({ children, title, helper }) => {
  return (
    <div className="w-full h-screen grid grid-cols-12 justify-center items-center">
      <div className="col-span-6 flex justify-center items-center p-5 py-10 bg-[--base_color] h-full">
        <img src={logo} className="w-[300px]" alt="" />
      </div>
      <div className="col-span-6 h-full flex justify-center items-center">
        <div className="flex gap-[30px] rounded-[20px] flex-col max-w-[600px] w-full h-fit p-[50px]">
