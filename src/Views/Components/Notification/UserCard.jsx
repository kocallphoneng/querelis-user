...
const UserCard = () => {
  return (
    <div className="flex relative cursor-pointer items-center gap-4 bg-white p-2">
      <span className="min-w-[50px] h-[50px] bg-gray-300 rounded-full"></span>
      ...
      <span className="absolute rounded-full items-end right-2 bottom-1 w-[10px] h-[10px] bg-blue-500"></span>
    </div>
  );
};
